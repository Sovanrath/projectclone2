    ...
    <div className='bg-[#121121] pb-[3rem] pt-[4rem] md:pt-[8rem]'>
        <div className='grid grid-cols-1 md:grid-cols-2 w-[80%] mx-auto gap-[3rem] items-center'>
           <div>
                ...
                <h2 className='text-[20px] md:text-[35px] lg:text-[45px] md:leading-[3rem] leading-[2rem] capitalize
                ...
                <div className='mb-[3rem] flex items-center md:space-x-10'>
                    ...
                    <p className='text-[19px] text-slate-300 w-[80%]'>
                        ...
                        Repellat quidem obcaecati maxime ipsa, facere possimus error eveniet 
                        hic recusandae excepturi quisquam animi molestiae suscipit. Fuga!
                    </p>
                </div>
