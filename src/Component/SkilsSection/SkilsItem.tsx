  ...
  return (
    <div className='mb-[4rem] md:mb-[8rem]'>
        ...
        <p className='text-[#aaaaaa] font-normal w-[80%] text-[17px] opacity-80'>
            ...
            aliquam in, nam illum eius quidem eligendi rerum hic sapiente distinctio 
            accusamus sunt doloremque reprehenderit nulla labore! Minima aliquid facere 
            quae non dolor consequuntur reiciendis, repellendus illo, cum, dolore corrupti unde!
        </p>
    </div>
  )
}
